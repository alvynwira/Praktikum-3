...
<body>
    ...
    <section class="profileku text-center">
        <img src="<?php echo e(Vite::asset('resources/img/profile.jpg')); ?>" class="rounded-circle img-thumbnail"
        ...
        <div class="container pt-8">
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="<?php echo e(Vite::asset('resources/img/Red.jpg')); ?>"class="card-img-top" alt="Project 1">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="<?php echo e(Vite::asset('resources/img/SI CUP.jpg')); ?>" class="card-img-top"
                            alt="Project 2">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="<?php echo e(Vite::asset('resources/img/White.jpg')); ?>" class="card-img-top" alt="Project 3">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="<?php echo e(Vite::asset('resources/img/TUS CUP.jpg')); ?>"class="card-img-top" alt="Project 3">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="<?php echo e(Vite::asset('resources/img/Champion.jpg')); ?>"class="card-img-top"
                            alt="Project 3">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="<?php echo e(Vite::asset('resources/img/DBL.jpg')); ?>"class="card-img-top" alt="Project 3">
                        <div class="card-body">
                    ...
                    <div id="carouselExampleDark" class="carousel carousel-light slide col-10">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="<?php echo e(Vite::asset('resources/img/asset1.jpeg')); ?>" class="d-block w-100" alt="fototalent">
                                <div class="carousel-caption d-none d-md-block text-white">
                                    <p>Harmony Excellent Integrity</p>
                                </div>
                            </div>
                            <div class="carousel-item" data-bs-interval="2000">
                                <img src="<?php echo e(Vite::asset('resources/img/asset2.jpeg')); ?>" class="d-block w-100" alt="fototalent">
                                <div class="carousel-caption d-none d-md-block text-white">
                                    <p>Hard Work Makes the Dream Work</p>
                                </div>
                            </div>
                            <div class="carousel-item">
                                <img src="<?php echo e(Vite::asset('resources/img/asset3.jpeg')); ?>" class="d-block w-100" alt="fototalent">
                                <div class="carousel-caption d-none d-md-block text-white">
...
<?php /**PATH C:\SEMESTER 3\Pengembangan Aplikasi Website\ALL FRAMEWORK LARAVEL\PraktikumModul11 - Copy\resources\views/personalweb.blade.php ENDPATH**/ ?>